...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Apr 05 13:15:49 CST 2011
  */
public class Parser extends java_cup.runtime.lr_parser {
 ...
 return scanner.next_token(); 
    ...
    public Parser(Scanner scanner, ErrorMsg errorMsg) {
        super(scanner);
    ...
    public void report_error(String message, Object o) {
        if (o instanceof java_cup.runtime.Symbol) {
            ...
            if (s.sym == sym.error)
                m += ": " + s.value.toString();
            errorMsg.report(m, s.left);
        }
    }

    public void report_fatal_error(String message, Object o) {
        errorMsg.report("Cannot recover from previous error(s). Halting");
    }
